...
\author[2]{\normalsize Nicolas Pardo}

\affil[1,2]{\small  Escuela de Ingeniería,Universidad de los Andes\\
\texttt{{nd.alvarez11, ns.pardo10}@uniandes.edu.col}}
...
% Date and time: vie., jun. 29, 2018 - 3:02:05 p. m.
...
% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: vie., jun. 29, 2018 - 3:02:11 p. m.
\begin{table}[!htbp] \centering 
...
% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: vie., jun. 29, 2018 - 3:02:12 p. m.
\begin{table}[!htbp] \centering 
